package com.nurzainpradana.androidfundamental.consumerapp.ui.setting;
...
import com.nurzainpradana.androidfundamental.consumerapp.util.receiver.AlarmReceiver;
        ...
        switchToggle.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    ...
                    String repeatMessage = SettingAct.this.getResources().getString(R.string.alarm_message);
                    Context context = SettingAct.this.getApplicationContext();
                    ...
                    SettingAct.this.saveSetting(true);
                } else {
                    alarmReceiver.cancelAlarm(SettingAct.this);
                    SettingAct.this.saveSetting(false);
                }
            }
        });
